...
data = pd.read_excel("C:/Users/Yanny/Desktop/NavMobility Interview/Problem2/walkertrain.xlsx")  #<----- File path had to be used and openpyxl library
test = pd.read_excel("C:/Users/Yanny/Desktop/NavMobility Interview/Problem2/walkertest.xlsx")
...
pred_train = E_Anfis.predict(X_train,bestParam,bestModel)
pearsonr(y_train.reshape(-1),pred_train.reshape(-1))

pred_test = E_Anfis.predict(X_test,bestParam,bestModel)
pearsonr(y_test.reshape(-1),pred_test.reshape(-1))